...
<#-- @ftlvariable name="expertise" type="java.lang.String" -->
...
<head>
    ...
    <meta name="description" content="Fly me to Mars - register.">
</head>
...
<form name="create_user" action="/register" method="POST">
    <div id="admin_left_pane" class="fieldset_without_border">
        ...
        <ol>
            ...
            <li>
                <label for="expertise" class="bold">Expertise:
                </label>
                <input id="expertise" name="expertise" type="text" value="${expertise}">
            </li>
        </ol>
    </div>
